...
exports.ListSectorsQueryDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var ListSectorsQueryDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: [0, 1], description: '1 active, 0 inactive' }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.IsEnum)([0, 1])];
            _sortBy_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: ['id', 'name'], default: 'id' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(['id', 'name'])];
...
exports.ListSectorsQueryDto = ListSectorsQueryDto;
