...
export enum NotificationTemplateCode {
  ...
  /** Shared vendor notice when admin rejects registration / certification / renew payment proof. */
  PAYMENT_REJECTED = 'PAYMENT_REJECTED',
  /** Shared vendor notice when admin approves registration / renew payment proof. */
