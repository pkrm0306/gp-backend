...
exports.ProcessInnovationSchema = exports.ProcessInnovation = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var ProcessInnovation = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'process_innovation', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _processInnovationId_decorators;
    var _processInnovationId_initializers = [];
    var _processInnovationId_extraInitializers = [];
    ...
    var ProcessInnovation = _classThis = /** @class */ (function () {
        function ProcessInnovation_1() {
            this.processInnovationId = __runInitializers(this, _processInnovationId_initializers, void 0);
            this.vendorId = (__runInitializers(this, _processInnovationId_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            ...
            this.innovationImplementationDocuments = (__runInitializers(this, _innovationImplementationDetails_extraInitializers), __runInitializers(this, _innovationImplementationDocuments_initializers, void 0)); // 0=No File Available, 1=File Available
            this.processInnovationStatus = (__runInitializers(this, _innovationImplementationDocuments_extraInitializers), __runInitializers(this, _processInnovationStatus_initializers, void 0)); // 0=Pending, 1=Completed
        ...
        return ProcessInnovation_1;
    }());
    __setFunctionName(_classThis, "ProcessInnovation");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _processInnovationId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        __esDecorate(null, null, _processInnovationId_decorators, { kind: "field", name: "processInnovationId", static: false, private: false, access: { has: function (obj) { return "processInnovationId" in obj; }, get: function (obj) { return obj.processInnovationId; }, set: function (obj, value) { obj.processInnovationId = value; } }, metadata: _metadata }, _processInnovationId_initializers, _processInnovationId_extraInitializers);
        ...
        ProcessInnovation = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessInnovation = _classThis;
}();
exports.ProcessInnovation = ProcessInnovation;
exports.ProcessInnovationSchema = mongoose_1.SchemaFactory.createForClass(ProcessInnovation);
exports.ProcessInnovationSchema.index({ urnNo: 1 }, { unique: true, name: 'uniq_process_innovation_urn' });
