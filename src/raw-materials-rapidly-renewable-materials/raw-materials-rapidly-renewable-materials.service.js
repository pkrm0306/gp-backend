...
exports.RawMaterialsRapidlyRenewableMaterialsService = void 0;
...
var RAPIDLY_RENEWABLE_UNIT_KEYS = [
    'unitName',
    'year',
    'unit1',
    'yeardata1',
...
var RawMaterialsRapidlyRenewableMaterialsService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var RawMaterialsRapidlyRenewableMaterialsService = _classThis = /** @class */ (function () {
        function RawMaterialsRapidlyRenewableMaterialsService_1(model, allProductDocumentModel, productModel, sequenceHelper, documentVersioningService) {
            this.model = model;
        ...
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.toObjectId = function (id, fieldName) {
        ...
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.roundToTwo = function (value) {
            return Math.round(value * 100) / 100;
        };
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.saveFileToUrnFolder = function (file, urnNo, fileType) {
        ...
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.toResponseUnit = function (row) {
        ...
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.mapProductDocument = function (d) {
        ...
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.create = function (dto, vendorId, rapidlyRenewableFile) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            now = new Date();
                            docsToCreate = [];
                            meaningfulUnits = (0, raw_materials_upload_util_2.filterMeaningfulRows)(((_a = dto.units) !== null && _a !== void 0 ? _a : []), RAPIDLY_RENEWABLE_UNIT_KEYS);
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.sequenceHelper.getRawMaterialsRapidlyRenewableMaterialsId()];
                        case 2:
                            id = _d.sent();
                            docsToCreate.push(__assign(__assign({ rawMaterialsRapidlyRenewableMaterialsId: id, urnNo: urnNo, vendorId: vendorObjectId }, mapped), { createdDate: now, updatedDate: now }));
                            _d.label = 3;
                        case 3:
                            _i++;
                            return [3 /*break*/, 1];
                        ...
                        case 6:
                            created = _d.sent();
                            documents = [];
                            if (!rapidlyRenewableFile) return [3 /*break*/, 11];
                            return [4 /*yield*/, this.saveFileToUrnFolder(rapidlyRenewableFile, urnNo, 'rapidly_renewable_supporting_document')];
                        case 7:
                        ...
                        case 8:
                            ...
                            return [4 /*yield*/, this.allProductDocumentModel.create({
                                    ...
                                    urnNo: urnNo,
                                    eoiNo: '',
                                    documentForm: document_section_key_constants_1.DocumentSectionKey.RAW_MATERIALS_RAPIDLY_RENEWABLE_MATERIALS,
                                    documentFormSubsection: 'supporting_documents',
                                    formPrimaryId: (_c = (_b = created[0]) === null || _b === void 0 ? void 0 : _b.rawMaterialsRapidlyRenewableMaterialsId) !== null && _c !== void 0 ? _c : productDocumentId,
                        ...
                        case 9:
                            ...
                            return [4 /*yield*/, (0, certification_document_version_util_1.trackCertificationDocumentAfterCreate)({
                                    ...
                                    urnNo: urnNo,
                                    sectionKey: document_section_key_constants_1.DocumentSectionKey.RAW_MATERIALS_RAPIDLY_RENEWABLE_MATERIALS,
                        ...
                        case 12:
                            error_1 = _d.sent();
                            console.error('[Raw Materials Rapidly Renewable Materials] Create error:', error_1);
        ...
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.countPersistedByUrn = function (urnNo, vendorId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        RawMaterialsRapidlyRenewableMaterialsService_1.prototype.listByUrn = function (urnNo, vendorId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_2 = _a.sent();
                            console.error('[Raw Materials Rapidly Renewable Materials] List error:', error_2);
        ...
        return RawMaterialsRapidlyRenewableMaterialsService_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsRapidlyRenewableMaterialsService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RawMaterialsRapidlyRenewableMaterialsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsRapidlyRenewableMaterialsService = _classThis;
}();
exports.RawMaterialsRapidlyRenewableMaterialsService = RawMaterialsRapidlyRenewableMaterialsService;
