...
exports.RawMaterialsRapidlyRenewableMaterialsSchema = exports.RawMaterialsRapidlyRenewableMaterials = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var raw_materials_schema_props_1 = require("../../common/raw-materials/raw-materials-schema.props");
var RawMaterialsRapidlyRenewableMaterials = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({
            collection: 'raw_materials_rapidly_renewable_materials',
            timestamps: false,
        })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _rawMaterialsRapidlyRenewableMaterialsId_decorators;
    var _rawMaterialsRapidlyRenewableMaterialsId_initializers = [];
    var _rawMaterialsRapidlyRenewableMaterialsId_extraInitializers = [];
    ...
    var RawMaterialsRapidlyRenewableMaterials = _classThis = /** @class */ (function () {
        function RawMaterialsRapidlyRenewableMaterials_1() {
            this.rawMaterialsRapidlyRenewableMaterialsId = __runInitializers(this, _rawMaterialsRapidlyRenewableMaterialsId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _rawMaterialsRapidlyRenewableMaterialsId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
        ...
        return RawMaterialsRapidlyRenewableMaterials_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsRapidlyRenewableMaterials");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _rawMaterialsRapidlyRenewableMaterialsId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        __esDecorate(null, null, _rawMaterialsRapidlyRenewableMaterialsId_decorators, { kind: "field", name: "rawMaterialsRapidlyRenewableMaterialsId", static: false, private: false, access: { has: function (obj) { return "rawMaterialsRapidlyRenewableMaterialsId" in obj; }, get: function (obj) { return obj.rawMaterialsRapidlyRenewableMaterialsId; }, set: function (obj, value) { obj.rawMaterialsRapidlyRenewableMaterialsId = value; } }, metadata: _metadata }, _rawMaterialsRapidlyRenewableMaterialsId_initializers, _rawMaterialsRapidlyRenewableMaterialsId_extraInitializers);
        ...
        RawMaterialsRapidlyRenewableMaterials = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsRapidlyRenewableMaterials = _classThis;
}();
exports.RawMaterialsRapidlyRenewableMaterials = RawMaterialsRapidlyRenewableMaterials;
exports.RawMaterialsRapidlyRenewableMaterialsSchema = mongoose_1.SchemaFactory.createForClass(RawMaterialsRapidlyRenewableMaterials);
