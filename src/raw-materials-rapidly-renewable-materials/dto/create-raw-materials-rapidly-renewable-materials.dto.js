...
exports.CreateRawMaterialsRapidlyRenewableMaterialsDto = exports.RapidlyRenewableUnitDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var RapidlyRenewableUnitDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function RapidlyRenewableUnitDto() {
            ...
            return RapidlyRenewableUnitDto;
        }()),
        (function () {
...
exports.RapidlyRenewableUnitDto = RapidlyRenewableUnitDto;
var CreateRawMaterialsRapidlyRenewableMaterialsDto = function () {
    var _a;
    ...
    var _rapidlyRenewableFileName_decorators;
    var _rapidlyRenewableFileName_initializers = [];
    var _rapidlyRenewableFileName_extraInitializers = [];
    var _units_decorators;
    var _units_initializers = [];
    var _units_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreateRawMaterialsRapidlyRenewableMaterialsDto() {
                ...
                this.rapidlyRenewableFileName = (__runInitializers(this, _vendorId_extraInitializers), __runInitializers(this, _rapidlyRenewableFileName_initializers, void 0));
                this.units = (__runInitializers(this, _rapidlyRenewableFileName_extraInitializers), __runInitializers(this, _units_initializers, void 0));
                __runInitializers(this, _units_extraInitializers);
            }
            return CreateRawMaterialsRapidlyRenewableMaterialsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            ...
            _rapidlyRenewableFileName_decorators = [(0, swagger_1.ApiProperty)({
            ...
            _units_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.ValidateNested)({ each: true }), (0, class_transformer_1.Type)(function () { return RapidlyRenewableUnitDto; })];
            ...
            __esDecorate(null, null, _rapidlyRenewableFileName_decorators, { kind: "field", name: "rapidlyRenewableFileName", static: false, private: false, access: { has: function (obj) { return "rapidlyRenewableFileName" in obj; }, get: function (obj) { return obj.rapidlyRenewableFileName; }, set: function (obj, value) { obj.rapidlyRenewableFileName = value; } }, metadata: _metadata }, _rapidlyRenewableFileName_initializers, _rapidlyRenewableFileName_extraInitializers);
...
exports.CreateRawMaterialsRapidlyRenewableMaterialsDto = CreateRawMaterialsRapidlyRenewableMaterialsDto;
