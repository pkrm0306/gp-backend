...
var CreatePartnerDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _name_decorators = [(0, swagger_1.ApiProperty)({ description: 'Partner / team member name' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return String(value !== null && value !== void 0 ? value : '').trim();
                })];
            _email_decorators = [(0, swagger_1.ApiProperty)({ description: 'Email address (used as username)' }), (0, class_validator_1.IsEmail)(), (0, class_validator_1.IsNotEmpty)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
            ...
            _countryCode_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    example: '+91',
                    description: 'Country dial code from the phone selector (e.g. +91). Required when mobile/phone is local digits without +.',
            ...
            _phone_decorators = [(0, swagger_1.ApiPropertyOptional)({
                ...
                }), (0, class_validator_1.ValidateIf)(function (dto) { var _b; return !((_b = dto.mobile) === null || _b === void 0 ? void 0 : _b.trim()); }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _mobile_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Mobile number (vendor UI field; alias for phone)',
                }), (0, class_validator_1.ValidateIf)(function (dto) { var _b; return !((_b = dto.phone) === null || _b === void 0 ? void 0 : _b.trim()); }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _password_decorators = [(0, swagger_1.ApiProperty)({ description: 'Password (min 6 characters)' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MinLength)(6)];
            _confirmPassword_decorators = [(0, swagger_1.ApiProperty)({ description: 'Must match password' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
