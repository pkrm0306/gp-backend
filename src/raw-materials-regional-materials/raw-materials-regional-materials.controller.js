...
exports.RawMaterialsRegionalMaterialsController = void 0;
...
function isRegionalMaterialsUploadField(fieldname) {
    var field = String(fieldname !== null && fieldname !== void 0 ? fieldname : '').trim();
    if (!field) {
        return false;
    }
    ...
    return (field.startsWith('regionalMaterialsFile') ||
        field.startsWith('regional_materials_file'));
}
var RawMaterialsRegionalMaterialsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Raw Materials Regional Materials'), (0, common_1.Controller)('raw-materials-regional-materials'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var RawMaterialsRegionalMaterialsController = _classThis = /** @class */ (function () {
        function RawMaterialsRegionalMaterialsController_1(service, stepGate) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.stepGate = stepGate;
        }
        RawMaterialsRegionalMaterialsController_1.prototype.create = function (user, req) {
            return __awaiter(this, void 0, void 0, function () {
                var body, units, allUploadedFiles, uploadFiles, resolvedUploadFiles, urnNo, persistedRecordCount, dto, data;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            allUploadedFiles = (0, raw_materials_upload_util_2.collectAllUploadFiles)(req.files);
                            uploadFiles = allUploadedFiles.filter(function (f) { var _a; return isRegionalMaterialsUploadField(String((_a = f.fieldname) !== null && _a !== void 0 ? _a : '')); });
                            resolvedUploadFiles = uploadFiles.length > 0 ? uploadFiles : allUploadedFiles;
                            if (resolvedUploadFiles.length > 0) {
                                (0, raw_materials_upload_util_2.assertRawMaterialsDocumentTypes)(resolvedUploadFiles);
                            }
        ...
        RawMaterialsRegionalMaterialsController_1.prototype.listByUrn = function (user, urnNo) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
        ...
        return RawMaterialsRegionalMaterialsController_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsRegionalMaterialsController");
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({
                ...
                description: '**units** replaces all rows for the URN. Multiple supporting PDF/Excel uploads supported via repeated `regionalMaterialsFile` fields. `existingDocumentIds`: omit = keep all saved docs; JSON array = retain only listed productDocumentId values.',
                ...
                schema: {
                    ...
                    properties: {
                        ...
                        existingDocumentIds: {
                            type: 'string',
                            description: 'JSON array of productDocumentId values to retain when removing files',
                        },
                    },
                },
        ...
        RawMaterialsRegionalMaterialsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsRegionalMaterialsController = _classThis;
}();
exports.RawMaterialsRegionalMaterialsController = RawMaterialsRegionalMaterialsController;
