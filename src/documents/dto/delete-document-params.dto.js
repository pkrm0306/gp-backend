...
exports.DeleteDocumentParamsDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var DeleteDocumentParamsDto = function () {
    var _a;
    var _documentId_decorators;
    var _documentId_initializers = [];
    var _documentId_extraInitializers = [];
    return _a = /** @class */ (function () {
            function DeleteDocumentParamsDto() {
                this.documentId = __runInitializers(this, _documentId_initializers, void 0);
                __runInitializers(this, _documentId_extraInitializers);
            }
            return DeleteDocumentParamsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _documentId_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Product document id (`productDocumentId` number) or MongoDB `_id` (24-char hex)',
                    example: '1001',
...
exports.DeleteDocumentParamsDto = DeleteDocumentParamsDto;
