...
var ActivityLog = function () {
    ...
    var ActivityLog = _classThis = /** @class */ (function () {
        function ActivityLog_1() {
            ...
            this.created_at = __runInitializers(this, _status_extraInitializers);
        }
        return ActivityLog_1;
    }());
    __setFunctionName(_classThis, "ActivityLog");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _vendor_id_decorators = [(0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: 'Vendor', required: true })];
        _manufacturer_id_decorators = [(0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: 'Manufacturer', required: true })];
        _urn_no_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _activities_id_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number })];
        _activity_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _activity_status_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number })];
        _sub_activities_id_decorators = [(0, mongoose_1.Prop)({ type: Number })];
        _responsibility_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _next_responsibility_decorators = [(0, mongoose_1.Prop)()];
        _next_acitivities_id_decorators = [(0, mongoose_1.Prop)({ type: Number })];
        _next_activity_decorators = [(0, mongoose_1.Prop)()];
