...
exports.ProcessLifeCycleApproachController = void 0;
var common_1 = require("@nestjs/common");
var platform_express_1 = require("@nestjs/platform-express");
var swagger_1 = require("@nestjs/swagger");
var multer_universal_config_1 = require("../common/upload/multer-universal.config");
var jwt_auth_guard_1 = require("../common/guards/jwt-auth.guard");
var ProcessLifeCycleApproachController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Process Life Cycle Approach'), (0, common_1.Controller)('process-life-cycle-approach'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _create_decorators;
    var ProcessLifeCycleApproachController = _classThis = /** @class */ (function () {
        function ProcessLifeCycleApproachController_1(processLifeCycleApproachService) {
            this.processLifeCycleApproachService = (__runInitializers(this, _instanceExtraInitializers), processLifeCycleApproachService);
        }
        ProcessLifeCycleApproachController_1.prototype.create = function (user, body, files, req) {
            return __awaiter(this, void 0, void 0, function () {
                var dto, lifeCycleAssesmentReportsFiles, lifeCycleImplementationDocumentsFiles, data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            lifeCycleAssesmentReportsFiles = (files || []).filter(function (f) { return f.fieldname === 'lifeCycleAssesmentReportsFile'; });
                            lifeCycleImplementationDocumentsFiles = (files || []).filter(function (f) { return f.fieldname === 'lifeCycleImplementationDocumentsFile'; });
                            // Validate file names if files are uploaded
                            if (lifeCycleAssesmentReportsFiles.length > 0 &&
                                (!dto.lifeCycleAssesmentReportsFileName ||
                                    dto.lifeCycleAssesmentReportsFileName.trim() === '')) {
                                throw new common_1.BadRequestException('lifeCycleAssesmentReportsFileName is required when uploading lifeCycleAssesmentReportsFile');
                            }
                            if (lifeCycleImplementationDocumentsFiles.length > 0 &&
                                (!dto.lifeCycleImplementationDocumentsFileName ||
                                    dto.lifeCycleImplementationDocumentsFileName.trim() === '')) {
                                throw new common_1.BadRequestException('lifeCycleImplementationDocumentsFileName is required when uploading lifeCycleImplementationDocumentsFile');
                            }
                            return [4 /*yield*/, this.processLifeCycleApproachService.createProcessLifeCycleApproach(dto, user.vendorId, lifeCycleAssesmentReportsFiles, lifeCycleImplementationDocumentsFiles)];
                        case 1:
                            data = _a.sent();
        ...
        return ProcessLifeCycleApproachController_1;
    }());
    __setFunctionName(_classThis, "ProcessLifeCycleApproachController");
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, common_1.UseInterceptors)((0, platform_express_1.AnyFilesInterceptor)((0, multer_universal_config_1.certificationMultipartMemoryMulterOptions)())), (0, swagger_1.ApiOperation)({
                ...
                description: 'Creates process life cycle approach data with file uploads. Files are stored in URN-specific folder (uploads/urns/{urn_no}/). Only PDF and Excel (.pdf, .xls, .xlsx) uploads are allowed.',
                ...
                schema: {
                    ...
                    properties: {
                        ...
                        lifeCycleImplementationDocumentsFile: {
                            ...
                            description: 'Life cycle implementation documents files (multiple supported)',
                        },
                    },
                },
        ...
        ProcessLifeCycleApproachController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessLifeCycleApproachController = _classThis;
}();
exports.ProcessLifeCycleApproachController = ProcessLifeCycleApproachController;
