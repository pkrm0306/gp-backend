...
exports.ProcessCommentsModule = void 0;
var common_1 = require("@nestjs/common");
var mongoose_1 = require("@nestjs/mongoose");
var process_comments_schema_1 = require("./schemas/process-comments.schema");
var process_comments_service_1 = require("./process-comments.service");
var process_comments_controller_1 = require("./process-comments.controller");
...
var ProcessCommentsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [process_comments_controller_1.ProcessCommentsController],
    ...
    var _classThis;
    var ProcessCommentsModule = _classThis = /** @class */ (function () {
        function ProcessCommentsModule_1() {
        }
        return ProcessCommentsModule_1;
    }());
    __setFunctionName(_classThis, "ProcessCommentsModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ProcessCommentsModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessCommentsModule = _classThis;
}();
