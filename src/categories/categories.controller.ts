...
export class CategoriesController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns categories from the categories collection. Optional filters: sector, status (category_status). Sort by category_name: sort=asc (A–Z, default) or sort=desc (Z–A).',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Multipart: optional text fields (category_name, category_raw_material_forms, category_status, sector) and optional file field **image**. Send at least one field or a new image.',
  })
  @ApiParam({ name: 'id', description: 'Category MongoDB _id' })
  @ApiBody({
    schema: {
