...
exports.UpdateCategoryStatusDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var UpdateCategoryStatusDto = function () {
    var _a;
    var _category_status_decorators;
    var _category_status_initializers = [];
    var _category_status_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UpdateCategoryStatusDto() {
                this.category_status = __runInitializers(this, _category_status_initializers, void 0);
                __runInitializers(this, _category_status_extraInitializers);
            }
            return UpdateCategoryStatusDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _category_status_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: 'category_status value' }), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(0)];
