...
exports.CreateCategoryMultipartDto = void 0;
 ...
 */
var CreateCategoryMultipartDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateCategoryMultipartDto() {
            ...
            return CreateCategoryMultipartDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _category_name_decorators = [(0, swagger_1.ApiProperty)({ example: 'Wooden Products' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _category_raw_material_forms_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    example: '1,3,2',
                    description: 'Comma-separated raw material form ids',
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _category_status_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 1, description: '1 = active (default)' }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)()];
            _sector_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 1, description: 'Sector id (defaults to 1)' }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1)];
...
exports.CreateCategoryMultipartDto = CreateCategoryMultipartDto;
