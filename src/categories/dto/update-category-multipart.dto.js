...
var UpdateCategoryMultipartDto = function () {
    ...
    return _a = /** @class */ (function () {
            function UpdateCategoryMultipartDto() {
                this.category_name = __runInitializers(this, _category_name_initializers, void 0);
                this.category_raw_material_forms = (__runInitializers(this, _category_name_extraInitializers), __runInitializers(this, _category_raw_material_forms_initializers, void 0));
                ...
                __runInitializers(this, _sector_extraInitializers);
            }
            return UpdateCategoryMultipartDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _category_name_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'Wooden Products' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _category_raw_material_forms_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: '1,3,2' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _category_status_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 1 }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(0)];
            _sector_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 1 }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1)];
...
exports.UpdateCategoryMultipartDto = UpdateCategoryMultipartDto;
