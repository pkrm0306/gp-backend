...
var AdminPatchUrnStatusBodyDto = function () {
    ...
    return _a = /** @class */ (function () {
            function AdminPatchUrnStatusBodyDto() {
            ...
            return AdminPatchUrnStatusBodyDto;
        }()),
        (function () {
            ...
            _updateStatusTo_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Target value. `urn_status`: 0–17 (includes renewal 12–17). `product_status`: 0–3.',
                    example: 6,
                    minimum: 0,
                    maximum: 17,
...
exports.AdminPatchUrnStatusBodyDto = AdminPatchUrnStatusBodyDto;
