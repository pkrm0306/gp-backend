...
exports.AdminRenewValidityDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var AdminRenewValidityDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function AdminRenewValidityDto() {
                ...
                this.preview = (__runInitializers(this, _validTillDate_extraInitializers), __runInitializers(this, _preview_initializers, void 0));
                this.startNewRenewalCycle = (__runInitializers(this, _preview_extraInitializers), __runInitializers(this, _startNewRenewalCycle_initializers, void 0));
                __runInitializers(this, _startNewRenewalCycle_extraInitializers);
            }
            return AdminRenewValidityDto;
        }()),
        (function () {
            ...
            _preview_decorators = [(0, swagger_1.ApiPropertyOptional)({
            ...
            _startNewRenewalCycle_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'When true (default on PATCH /renew/admin/test-validity), starts a new renewal cycle. Set false for validity-only update.',
                    default: true,
                }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
...
exports.AdminRenewValidityDto = AdminRenewValidityDto;
