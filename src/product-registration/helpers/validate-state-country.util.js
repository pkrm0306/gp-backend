...
exports.assertStateBelongsToCountry = assertStateBelongsToCountry;
 ...
 */
function assertStateBelongsToCountry(statesService, countriesService, stateId, countryId) {
    return __awaiter(this, void 0, void 0, function () {
        var state, country, stateCountryCode, countryCode;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, statesService.findById(stateId)];
                case 1:
                    state = _b.sent();
                    if (!state) {
                        throw new common_1.NotFoundException("State with ID ".concat(stateId, " not found"));
                    }
                    return [4 /*yield*/, countriesService.findById(countryId)];
                case 2:
                    country = _b.sent();
                    if (!country) {
                    ...
                    stateCountryCode = state.country_code;
                    countryCode = (_a = country.country_code) !== null && _a !== void 0 ? _a : country.countryCode;
