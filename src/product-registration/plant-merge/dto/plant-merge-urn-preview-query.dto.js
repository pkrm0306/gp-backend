...
exports.PlantMergeUrnPreviewQueryDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var PlantMergeUrnPreviewQueryDto = function () {
    var _a;
    var _sourceUrnNo_decorators;
    var _sourceUrnNo_initializers = [];
    var _sourceUrnNo_extraInitializers = [];
    return _a = /** @class */ (function () {
            function PlantMergeUrnPreviewQueryDto() {
                this.sourceUrnNo = __runInitializers(this, _sourceUrnNo_initializers, void 0);
                __runInitializers(this, _sourceUrnNo_extraInitializers);
            }
            return PlantMergeUrnPreviewQueryDto;
        }()),
        (function () {
...
exports.PlantMergeUrnPreviewQueryDto = PlantMergeUrnPreviewQueryDto;
