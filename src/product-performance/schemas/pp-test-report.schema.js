...
exports.PpTestReportSchema = exports.PpTestReport = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var PpTestReport = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'process_pp_test_reports', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _productPerformanceTestReportId_decorators;
    var _productPerformanceTestReportId_initializers = [];
    var _productPerformanceTestReportId_extraInitializers = [];
    ...
    var PpTestReport = _classThis = /** @class */ (function () {
        function PpTestReport_1() {
            this.productPerformanceTestReportId = __runInitializers(this, _productPerformanceTestReportId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _productPerformanceTestReportId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
            this.vendorId = (__runInitializers(this, _urnNo_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            this.processProductPerformanceId = (__runInitializers(this, _vendorId_extraInitializers), __runInitializers(this, _processProductPerformanceId_initializers, void 0));
            this.productName = (__runInitializers(this, _processProductPerformanceId_extraInitializers), __runInitializers(this, _productName_initializers, void 0));
        ...
        return PpTestReport_1;
    }());
    __setFunctionName(_classThis, "PpTestReport");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _productPerformanceTestReportId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _processProductPerformanceId_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _productName_decorators = [(0, mongoose_1.Prop)({ default: '' })];
        _testReportFileName_decorators = [(0, mongoose_1.Prop)({ default: '' })];
        _normalizedProductName_decorators = [(0, mongoose_1.Prop)({ required: false, default: '' })];
        _normalizedTestReportFileName_decorators = [(0, mongoose_1.Prop)({ required: false, default: '' })];
        _createdDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _updatedDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        __esDecorate(null, null, _productPerformanceTestReportId_decorators, { kind: "field", name: "productPerformanceTestReportId", static: false, private: false, access: { has: function (obj) { return "productPerformanceTestReportId" in obj; }, get: function (obj) { return obj.productPerformanceTestReportId; }, set: function (obj, value) { obj.productPerformanceTestReportId = value; } }, metadata: _metadata }, _productPerformanceTestReportId_initializers, _productPerformanceTestReportId_extraInitializers);
        ...
        PpTestReport = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PpTestReport = _classThis;
}();
exports.PpTestReport = PpTestReport;
exports.PpTestReportSchema = mongoose_1.SchemaFactory.createForClass(PpTestReport);
exports.PpTestReportSchema.index({ urnNo: 1, normalizedProductName: 1, normalizedTestReportFileName: 1 }, {
    unique: true,
