...
exports.TestReportEntryDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var TestReportEntryDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function TestReportEntryDto() {
                ...
                __runInitializers(this, _testReportFileName_extraInitializers);
            }
            return TestReportEntryDto;
        }()),
        (function () {
            ...
            _testReportFileName_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Test report display name / file label (optional; at least one column per row may be filled)',
...
exports.TestReportEntryDto = TestReportEntryDto;
