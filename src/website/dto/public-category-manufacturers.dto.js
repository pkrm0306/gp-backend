...
exports.PublicCategoryManufacturersDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var PublicCategoryManufacturersDto = function () {
    var _a;
    var _categoryId_decorators;
    var _categoryId_initializers = [];
    var _categoryId_extraInitializers = [];
    return _a = /** @class */ (function () {
            function PublicCategoryManufacturersDto() {
            ...
            return PublicCategoryManufacturersDto;
        }()),
        (function () {
...
exports.PublicCategoryManufacturersDto = PublicCategoryManufacturersDto;
