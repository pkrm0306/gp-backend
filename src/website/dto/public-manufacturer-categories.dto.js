...
exports.PublicManufacturerCategoriesDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var PublicManufacturerCategoriesDto = function () {
    var _a;
    var _manufacturerId_decorators;
    var _manufacturerId_initializers = [];
    var _manufacturerId_extraInitializers = [];
    return _a = /** @class */ (function () {
            function PublicManufacturerCategoriesDto() {
                this.manufacturerId = __runInitializers(this, _manufacturerId_initializers, void 0);
                __runInitializers(this, _manufacturerId_extraInitializers);
            }
            return PublicManufacturerCategoriesDto;
        }()),
        (function () {
...
exports.PublicManufacturerCategoriesDto = PublicManufacturerCategoriesDto;
