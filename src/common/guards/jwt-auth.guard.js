...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        ...
        JwtAuthGuard_1.prototype.handleRequest = function (err, user, info, context) {
            ...
            if (!user) {
                var infoName = info === null || info === void 0 ? void 0 : info.name;
                var infoMessage = info === null || info === void 0 ? void 0 : info.message;
                ...
                if (infoMessage === null || infoMessage === void 0 ? void 0 : infoMessage.toLowerCase().includes('no auth token')) {
                    throw new common_1.UnauthorizedException('Authorization token missing');
                }
                if (infoMessage) {
                    throw new common_1.UnauthorizedException(infoMessage);
                }
