...
exports.RawMaterialsGreenSupplyController = void 0;
...
var RawMaterialsGreenSupplyController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Raw Materials Green Supply'), (0, common_1.Controller)('raw-materials-green-supply'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var RawMaterialsGreenSupplyController = _classThis = /** @class */ (function () {
        function RawMaterialsGreenSupplyController_1(service, stepGate) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.stepGate = stepGate;
        }
        RawMaterialsGreenSupplyController_1.prototype.create = function (user, body, greenSupplyFile) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (greenSupplyFile) {
                                (0, raw_materials_upload_util_2.assertRawMaterialsDocumentTypes)([greenSupplyFile]);
                            }
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, this.service.create(dto, user.vendorId, greenSupplyFile)];
                        case 3:
                            data = _a.sent();
        ...
        RawMaterialsGreenSupplyController_1.prototype.listByUrn = function (user, urnNo) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return RawMaterialsGreenSupplyController_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsGreenSupplyController");
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({
            ...
            }), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('greenSupplyFile', (0, raw_materials_upload_util_1.rawMaterialsMultipartMemoryMulterOptions)())), (0, swagger_1.ApiConsumes)('multipart/form-data'), (0, swagger_1.ApiBody)({
                schema: {
                    type: 'object',
                    required: ['urnNo'],
                    properties: {
        ...
        RawMaterialsGreenSupplyController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsGreenSupplyController = _classThis;
}();
exports.RawMaterialsGreenSupplyController = RawMaterialsGreenSupplyController;
