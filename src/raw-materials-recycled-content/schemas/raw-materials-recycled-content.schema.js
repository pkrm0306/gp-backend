...
exports.RawMaterialsRecycledContentSchema = exports.RawMaterialsRecycledContent = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var raw_materials_schema_props_1 = require("../../common/raw-materials/raw-materials-schema.props");
var RawMaterialsRecycledContent = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'raw_materials_recycled_content', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _rawMaterialsRecycledContentId_decorators;
    var _rawMaterialsRecycledContentId_initializers = [];
    var _rawMaterialsRecycledContentId_extraInitializers = [];
    ...
    var RawMaterialsRecycledContent = _classThis = /** @class */ (function () {
        function RawMaterialsRecycledContent_1() {
            this.rawMaterialsRecycledContentId = __runInitializers(this, _rawMaterialsRecycledContentId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _rawMaterialsRecycledContentId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
        ...
        return RawMaterialsRecycledContent_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsRecycledContent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _rawMaterialsRecycledContentId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        __esDecorate(null, null, _rawMaterialsRecycledContentId_decorators, { kind: "field", name: "rawMaterialsRecycledContentId", static: false, private: false, access: { has: function (obj) { return "rawMaterialsRecycledContentId" in obj; }, get: function (obj) { return obj.rawMaterialsRecycledContentId; }, set: function (obj, value) { obj.rawMaterialsRecycledContentId = value; } }, metadata: _metadata }, _rawMaterialsRecycledContentId_initializers, _rawMaterialsRecycledContentId_extraInitializers);
        ...
        RawMaterialsRecycledContent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsRecycledContent = _classThis;
}();
exports.RawMaterialsRecycledContent = RawMaterialsRecycledContent;
exports.RawMaterialsRecycledContentSchema = mongoose_1.SchemaFactory.createForClass(RawMaterialsRecycledContent);
