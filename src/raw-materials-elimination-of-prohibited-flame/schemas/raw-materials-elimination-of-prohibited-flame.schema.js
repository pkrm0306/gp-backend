...
exports.RawMaterialsEliminationOfProhibitedFlameSchema = exports.RawMaterialsEliminationOfProhibitedFlame = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var RawMaterialsEliminationOfProhibitedFlame = function () {
    ...
    var _classThis;
    var _rawMaterialsEliminationOfProhibitedFlameId_decorators;
    var _rawMaterialsEliminationOfProhibitedFlameId_initializers = [];
    var _rawMaterialsEliminationOfProhibitedFlameId_extraInitializers = [];
    ...
    var RawMaterialsEliminationOfProhibitedFlame = _classThis = /** @class */ (function () {
        function RawMaterialsEliminationOfProhibitedFlame_1() {
            this.rawMaterialsEliminationOfProhibitedFlameId = __runInitializers(this, _rawMaterialsEliminationOfProhibitedFlameId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _rawMaterialsEliminationOfProhibitedFlameId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
            this.vendorId = (__runInitializers(this, _urnNo_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            this.measuresImplemented = (__runInitializers(this, _vendorId_extraInitializers), __runInitializers(this, _measuresImplemented_initializers, void 0));
        ...
        return RawMaterialsEliminationOfProhibitedFlame_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsEliminationOfProhibitedFlame");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _rawMaterialsEliminationOfProhibitedFlameId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        __esDecorate(null, null, _rawMaterialsEliminationOfProhibitedFlameId_decorators, { kind: "field", name: "rawMaterialsEliminationOfProhibitedFlameId", static: false, private: false, access: { has: function (obj) { return "rawMaterialsEliminationOfProhibitedFlameId" in obj; }, get: function (obj) { return obj.rawMaterialsEliminationOfProhibitedFlameId; }, set: function (obj, value) { obj.rawMaterialsEliminationOfProhibitedFlameId = value; } }, metadata: _metadata }, _rawMaterialsEliminationOfProhibitedFlameId_initializers, _rawMaterialsEliminationOfProhibitedFlameId_extraInitializers);
        ...
        RawMaterialsEliminationOfProhibitedFlame = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsEliminationOfProhibitedFlame = _classThis;
}();
exports.RawMaterialsEliminationOfProhibitedFlame = RawMaterialsEliminationOfProhibitedFlame;
exports.RawMaterialsEliminationOfProhibitedFlameSchema = mongoose_1.SchemaFactory.createForClass(RawMaterialsEliminationOfProhibitedFlame);
