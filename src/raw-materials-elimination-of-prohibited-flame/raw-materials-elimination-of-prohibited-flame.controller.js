...
exports.RawMaterialsEliminationOfProhibitedFlameController = void 0;
...
var RawMaterialsEliminationOfProhibitedFlameController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Raw Materials Elimination Of Prohibited Flame'), (0, common_1.Controller)('raw-materials-elimination-of-prohibited-flame'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var RawMaterialsEliminationOfProhibitedFlameController = _classThis = /** @class */ (function () {
        function RawMaterialsEliminationOfProhibitedFlameController_1(service, stepGate) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.stepGate = stepGate;
        }
        RawMaterialsEliminationOfProhibitedFlameController_1.prototype.create = function (user, body, prohibitedFlameFile) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (prohibitedFlameFile) {
                                (0, raw_materials_upload_util_2.assertRawMaterialsDocumentTypes)([prohibitedFlameFile]);
                            }
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, this.service.create(dto, user.vendorId, prohibitedFlameFile)];
                        case 3:
                            data = _a.sent();
        ...
        RawMaterialsEliminationOfProhibitedFlameController_1.prototype.listByUrn = function (user, urnNo) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return RawMaterialsEliminationOfProhibitedFlameController_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsEliminationOfProhibitedFlameController");
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({
            ...
            }), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('prohibitedFlameFile', (0, raw_materials_upload_util_1.rawMaterialsMultipartMemoryMulterOptions)())), (0, swagger_1.ApiConsumes)('multipart/form-data'), (0, swagger_1.ApiBody)({
                schema: {
                    type: 'object',
                    required: ['urnNo'],
                    properties: {
        ...
        RawMaterialsEliminationOfProhibitedFlameController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsEliminationOfProhibitedFlameController = _classThis;
}();
exports.RawMaterialsEliminationOfProhibitedFlameController = RawMaterialsEliminationOfProhibitedFlameController;
