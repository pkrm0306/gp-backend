...
exports.AdminListAccountDeletionQueryDto = void 0;
...
var AdminListAccountDeletionQueryDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function AdminListAccountDeletionQueryDto() {
                ...
                this.from = (__runInitializers(this, _reason_extraInitializers), __runInitializers(this, _from_initializers, void 0));
            ...
            return AdminListAccountDeletionQueryDto;
        }()),
        (function () {
            ...
            _search_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Case-insensitive search on requestNo, reason, description, adminRemarks',
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: account_deletion_request_schema_1.AccountDeletionStatus }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(account_deletion_request_schema_1.AccountDeletionStatus)];
...
exports.AdminListAccountDeletionQueryDto = AdminListAccountDeletionQueryDto;
