...
exports.RawMaterialsAdditivesController = void 0;
...
var RawMaterialsAdditivesController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Raw Materials Additives'), (0, common_1.Controller)('raw-materials-additives'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var RawMaterialsAdditivesController = _classThis = /** @class */ (function () {
        function RawMaterialsAdditivesController_1(service, stepGate) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.stepGate = stepGate;
        }
        RawMaterialsAdditivesController_1.prototype.create = function (user, body, additivesFile) {
            return __awaiter(this, void 0, void 0, function () {
                var units, urnNo, persistedRecordCount, dto, data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (additivesFile) {
                                (0, raw_materials_upload_util_2.assertRawMaterialsDocumentTypes)([additivesFile]);
                            }
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.service.create(dto, user.vendorId, additivesFile)];
                        case 3:
                            data = _a.sent();
        ...
        RawMaterialsAdditivesController_1.prototype.listByUrn = function (user, urnNo) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return RawMaterialsAdditivesController_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsAdditivesController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({ summary: 'Create raw materials additives record (per URN)' }), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('additivesFile', (0, raw_materials_upload_util_1.rawMaterialsMultipartMemoryMulterOptions)())), (0, swagger_1.ApiConsumes)('multipart/form-data', 'application/json'), (0, swagger_1.ApiBody)({
                schema: {
                    type: 'object',
                    required: ['urnNo'],
                    properties: {
        ...
        _listByUrn_decorators = [(0, common_1.Get)(':urn_no'), (0, swagger_1.ApiOperation)({ summary: 'List raw materials additives records by URN' }), (0, swagger_1.ApiParam)({ name: 'urn_no', example: 'URN-20260305124230' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Retrieved successfully' })];
        ...
        RawMaterialsAdditivesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsAdditivesController = _classThis;
}();
exports.RawMaterialsAdditivesController = RawMaterialsAdditivesController;
