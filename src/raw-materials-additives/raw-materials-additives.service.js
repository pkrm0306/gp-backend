...
exports.RawMaterialsAdditivesService = void 0;
...
var RawMaterialsAdditivesService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var RawMaterialsAdditivesService = _classThis = /** @class */ (function () {
        function RawMaterialsAdditivesService_1(model, allProductDocumentModel, productModel, sequenceHelper, documentVersioningService) {
            this.model = model;
        ...
        RawMaterialsAdditivesService_1.prototype.toObjectId = function (id, fieldName) {
        ...
        RawMaterialsAdditivesService_1.prototype.saveFileToUrnFolder = function (file, urnNo, fileType) {
        ...
        RawMaterialsAdditivesService_1.prototype.toResponseUnit = function (row) {
            var numericNormalized = (0, raw_materials_upload_util_2.withRawMaterialsNumericFields)({
                ...
                year3b: row.year3b,
                year3c: row.year3c,
            }, raw_materials_upload_util_2.RAW_MATERIALS_ADDITIVES_NUMERIC_KEYS);
        ...
        RawMaterialsAdditivesService_1.prototype.mapProductDocument = function (d) {
        ...
        RawMaterialsAdditivesService_1.prototype.create = function (dto, vendorId, additivesFile) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            now = new Date();
                            docsToCreate = [];
                            meaningfulUnits = (0, raw_materials_upload_util_2.filterMeaningfulRows)(((_a = dto.units) !== null && _a !== void 0 ? _a : []), ADDITIVES_UNIT_KEYS);
                            _i = 0, meaningfulUnits_1 = meaningfulUnits;
                            _d.label = 1;
                        case 1:
                            if (!(_i < meaningfulUnits_1.length)) return [3 /*break*/, 4];
                            unit = meaningfulUnits_1[_i];
                            return [4 /*yield*/, this.sequenceHelper.getRawMaterialsAdditivesId()];
                        case 2:
                            id = _d.sent();
                            mapped = (0, raw_materials_upload_util_2.mapRawMaterialsAdditivesUnitForSave)(unit);
                            docsToCreate.push(__assign(__assign({ rawMaterialsAdditivesId: id, urnNo: urnNo, vendorId: vendorObjectId }, mapped), { createdDate: now, updatedDate: now }));
                            _d.label = 3;
                        case 3:
                            _i++;
                            return [3 /*break*/, 1];
                        ...
                        case 6:
                            created = _d.sent();
                            documents = [];
                            if (!additivesFile) return [3 /*break*/, 11];
                            return [4 /*yield*/, this.saveFileToUrnFolder(additivesFile, urnNo, 'additives_supporting_document')];
                        case 7:
                        ...
                        case 8:
                            ...
                            return [4 /*yield*/, this.allProductDocumentModel.create({
                                    ...
                                    urnNo: urnNo,
                                    eoiNo: '',
                                    documentForm: document_section_key_constants_1.DocumentSectionKey.RAW_MATERIALS_ADDITIVES,
                                    documentFormSubsection: 'supporting_documents',
                                    formPrimaryId: (_c = (_b = created[0]) === null || _b === void 0 ? void 0 : _b.rawMaterialsAdditivesId) !== null && _c !== void 0 ? _c : productDocumentId,
                        ...
                        case 9:
                            ...
                            return [4 /*yield*/, (0, certification_document_version_util_1.trackCertificationDocumentAfterCreate)({
                                    ...
                                    urnNo: urnNo,
                                    sectionKey: document_section_key_constants_1.DocumentSectionKey.RAW_MATERIALS_ADDITIVES,
                        ...
                        case 12:
                            error_1 = _d.sent();
                            console.error('[Raw Materials Additives] Create error:', error_1);
                            if (error_1 instanceof common_1.BadRequestException) {
                                throw error_1;
                            }
                            throw new common_1.InternalServerErrorException(error_1.message || 'Failed to create raw materials additives record.');
                        case 13: return [2 /*return*/];
                    }
                });
            });
        };
        RawMaterialsAdditivesService_1.prototype.countPersistedByUrn = function (urnNo, vendorId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        RawMaterialsAdditivesService_1.prototype.listByUrn = function (urnNo, vendorId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_2 = _a.sent();
                            console.error('[Raw Materials Additives] List error:', error_2);
                            if (error_2 instanceof common_1.BadRequestException) {
                                throw error_2;
                            }
                            throw new common_1.InternalServerErrorException(error_2.message || 'Failed to list raw materials additives records.');
                        case 4: return [2 /*return*/];
                    }
                });
            });
        };
        return RawMaterialsAdditivesService_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsAdditivesService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RawMaterialsAdditivesService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsAdditivesService = _classThis;
}();
exports.RawMaterialsAdditivesService = RawMaterialsAdditivesService;
