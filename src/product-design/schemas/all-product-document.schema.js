...
exports.AllProductDocumentSchema = exports.AllProductDocument = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var document_section_key_constants_1 = require("../../common/constants/document-section-key.constants");
var AllProductDocument = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'all_product_documents', timestamps: false })];
    ...
    var AllProductDocument = _classThis = /** @class */ (function () {
        function AllProductDocument_1() {
            ...
            this.documentFormSubsection = (__runInitializers(this, _documentForm_extraInitializers), __runInitializers(this, _documentFormSubsection_initializers, void 0)); // e.g. 'eco_vision_upload', 'supporting_documents'
            this.formPrimaryId = (__runInitializers(this, _documentFormSubsection_extraInitializers), __runInitializers(this, _formPrimaryId_initializers, void 0)); // productDesignId
            this.documentName = (__runInitializers(this, _formPrimaryId_extraInitializers), __runInitializers(this, _documentName_initializers, void 0)); // stored filename
            this.documentOriginalName = (__runInitializers(this, _documentName_extraInitializers), __runInitializers(this, _documentOriginalName_initializers, void 0)); // original upload filename
            this.documentLink = (__runInitializers(this, _documentOriginalName_extraInitializers), __runInitializers(this, _documentLink_initializers, void 0)); // stored path/url
        ...
        return AllProductDocument_1;
    }());
    __setFunctionName(_classThis, "AllProductDocument");
    (function () {
        ...
        AllProductDocument = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AllProductDocument = _classThis;
}();
exports.AllProductDocument = AllProductDocument;
exports.AllProductDocumentSchema = mongoose_1.SchemaFactory.createForClass(AllProductDocument);
