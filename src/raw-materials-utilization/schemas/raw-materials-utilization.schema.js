...
exports.RawMaterialsUtilizationSchema = exports.RawMaterialsUtilization = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var RawMaterialsUtilization = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'raw_materials_utilization', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _rawMaterialsUtilizationId_decorators;
    var _rawMaterialsUtilizationId_initializers = [];
    var _rawMaterialsUtilizationId_extraInitializers = [];
    ...
    var RawMaterialsUtilization = _classThis = /** @class */ (function () {
        function RawMaterialsUtilization_1() {
            this.rawMaterialsUtilizationId = __runInitializers(this, _rawMaterialsUtilizationId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _rawMaterialsUtilizationId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
        ...
        return RawMaterialsUtilization_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsUtilization");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _rawMaterialsUtilizationId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        __esDecorate(null, null, _rawMaterialsUtilizationId_decorators, { kind: "field", name: "rawMaterialsUtilizationId", static: false, private: false, access: { has: function (obj) { return "rawMaterialsUtilizationId" in obj; }, get: function (obj) { return obj.rawMaterialsUtilizationId; }, set: function (obj, value) { obj.rawMaterialsUtilizationId = value; } }, metadata: _metadata }, _rawMaterialsUtilizationId_initializers, _rawMaterialsUtilizationId_extraInitializers);
        ...
        RawMaterialsUtilization = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsUtilization = _classThis;
}();
exports.RawMaterialsUtilization = RawMaterialsUtilization;
exports.RawMaterialsUtilizationSchema = mongoose_1.SchemaFactory.createForClass(RawMaterialsUtilization);
