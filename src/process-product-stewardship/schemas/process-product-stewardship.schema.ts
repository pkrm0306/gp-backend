...
export type ProcessProductStewardshipDocument = ProcessProductStewardship & Document;
...
export const ProcessProductStewardshipSchema = SchemaFactory.createForClass(ProcessProductStewardship);
