...
exports.ProcessPsStakeholderEduAwarnessSchema = exports.ProcessPsStakeholderEduAwarness = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var ProcessPsStakeholderEduAwarness = function () {
    ...
    var ProcessPsStakeholderEduAwarness = _classThis = /** @class */ (function () {
        function ProcessPsStakeholderEduAwarness_1() {
            ...
            this.processProductStewardshipId = (__runInitializers(this, _urnNo_extraInitializers), __runInitializers(this, _processProductStewardshipId_initializers, void 0));
            this.seaProgramDetails = (__runInitializers(this, _processProductStewardshipId_extraInitializers), __runInitializers(this, _seaProgramDetails_initializers, void 0));
        ...
        return ProcessPsStakeholderEduAwarness_1;
    }());
    __setFunctionName(_classThis, "ProcessPsStakeholderEduAwarness");
    (function () {
        ...
        _processProductStewardshipId_decorators = [(0, mongoose_1.Prop)({
        ...
        _seaSupportingDocuments_decorators = [(0, mongoose_1.Prop)({ type: Number, default: null, required: false })];
        ...
        ProcessPsStakeholderEduAwarness = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessPsStakeholderEduAwarness = _classThis;
}();
exports.ProcessPsStakeholderEduAwarness = ProcessPsStakeholderEduAwarness;
exports.ProcessPsStakeholderEduAwarnessSchema = mongoose_1.SchemaFactory.createForClass(ProcessPsStakeholderEduAwarness);
exports.ProcessPsStakeholderEduAwarnessSchema.index({ urnNo: 1, vendorId: 1, isDeleted: 1 }, { name: 'idx_ps_stakeholder_urn_vendor_active' });
