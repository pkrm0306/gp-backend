...
exports.RawMaterialsHazardousSchema = exports.RawMaterialsHazardous = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var RawMaterialsHazardous = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'raw_materials_hazardous', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _rawMaterialsHazardousId_decorators;
    var _rawMaterialsHazardousId_initializers = [];
    var _rawMaterialsHazardousId_extraInitializers = [];
    ...
    var RawMaterialsHazardous = _classThis = /** @class */ (function () {
        function RawMaterialsHazardous_1() {
            this.rawMaterialsHazardousId = __runInitializers(this, _rawMaterialsHazardousId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _rawMaterialsHazardousId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
            this.vendorId = (__runInitializers(this, _urnNo_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            this.eoiNo = (__runInitializers(this, _vendorId_extraInitializers), __runInitializers(this, _eoiNo_initializers, void 0));
        ...
        return RawMaterialsHazardous_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsHazardous");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _rawMaterialsHazardousId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _eoiNo_decorators = [(0, mongoose_1.Prop)({ required: false, default: '' })];
        _details_decorators = [(0, mongoose_1.Prop)({ required: false, default: '' })];
        _createdDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _updatedDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        __esDecorate(null, null, _rawMaterialsHazardousId_decorators, { kind: "field", name: "rawMaterialsHazardousId", static: false, private: false, access: { has: function (obj) { return "rawMaterialsHazardousId" in obj; }, get: function (obj) { return obj.rawMaterialsHazardousId; }, set: function (obj, value) { obj.rawMaterialsHazardousId = value; } }, metadata: _metadata }, _rawMaterialsHazardousId_initializers, _rawMaterialsHazardousId_extraInitializers);
        ...
        RawMaterialsHazardous = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsHazardous = _classThis;
}();
exports.RawMaterialsHazardous = RawMaterialsHazardous;
exports.RawMaterialsHazardousSchema = mongoose_1.SchemaFactory.createForClass(RawMaterialsHazardous);
