...
var CronController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Cron'), (0, common_1.Controller)('api/cron/certification-expiry'), (0, common_1.UseGuards)(cron_secret_guard_1.CronSecretGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var CronController = _classThis = /** @class */ (function () {
        ...
        CronController_1.prototype.weeklyMail = function () {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.certificationExpiryService.runWeeklyMail()];
                        case 1:
                            data = _a.sent();
                            return [2 /*return*/, { message: 'weeklyMail job finished', data: data }];
                    }
                });
            });
        };
        CronController_1.prototype.deactivationMail = function () {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.certificationExpiryService.runDeactivationMail()];
                        case 1:
                            data = _a.sent();
                            return [2 /*return*/, { message: 'deactivationMail job finished', data: data }];
                    }
                });
            });
        };
