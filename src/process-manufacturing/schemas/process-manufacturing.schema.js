...
exports.ProcessManufacturingSchema = exports.ProcessManufacturing = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var ProcessManufacturing = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'process_manufacturing', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _processManufacturingId_decorators;
    var _processManufacturingId_initializers = [];
    var _processManufacturingId_extraInitializers = [];
    ...
    var ProcessManufacturing = _classThis = /** @class */ (function () {
        function ProcessManufacturing_1() {
            this.processManufacturingId = __runInitializers(this, _processManufacturingId_initializers, void 0);
            this.vendorId = (__runInitializers(this, _processManufacturingId_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            this.urnNo = (__runInitializers(this, _vendorId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
            this.energyConservationSupportingDocuments = (__runInitializers(this, _urnNo_extraInitializers), __runInitializers(this, _energyConservationSupportingDocuments_initializers, void 0)); // 0=No File Available, 1=File Available
            ...
            this.energyConsumptionDocuments = (__runInitializers(this, _totalEnergyConsumption_extraInitializers), __runInitializers(this, _energyConsumptionDocuments_initializers, void 0)); // 0=No File Available, 1=File Available
            this.processManufacturingStatus = (__runInitializers(this, _energyConsumptionDocuments_extraInitializers), __runInitializers(this, _processManufacturingStatus_initializers, void 0)); // 0=Pending, 1=Completed
        ...
        return ProcessManufacturing_1;
    }());
    __setFunctionName(_classThis, "ProcessManufacturing");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _processManufacturingId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _energyConservationSupportingDocuments_decorators = [(0, mongoose_1.Prop)({ required: false, type: Number, default: null })];
        ...
        _energyConsumptionDocuments_decorators = [(0, mongoose_1.Prop)({ required: false, type: Number, default: null })];
        ...
        __esDecorate(null, null, _processManufacturingId_decorators, { kind: "field", name: "processManufacturingId", static: false, private: false, access: { has: function (obj) { return "processManufacturingId" in obj; }, get: function (obj) { return obj.processManufacturingId; }, set: function (obj, value) { obj.processManufacturingId = value; } }, metadata: _metadata }, _processManufacturingId_initializers, _processManufacturingId_extraInitializers);
        ...
        ProcessManufacturing = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessManufacturing = _classThis;
}();
exports.ProcessManufacturing = ProcessManufacturing;
exports.ProcessManufacturingSchema = mongoose_1.SchemaFactory.createForClass(ProcessManufacturing);
exports.ProcessManufacturingSchema.index({ urnNo: 1 }, { unique: true, name: 'uniq_process_manufacturing_urn' });
