...
var EventBrochureItemDto = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            return EventBrochureItemDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _heading_decorators = [(0, swagger_1.ApiProperty)({ example: 'GreenPro Summit Brochure' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return String(value !== null && value !== void 0 ? value : '').trim();
                }), (0, class_validator_1.MaxLength)(event_brochures_util_1.EVENT_BROCHURE_HEADING_MAX)];
            _link_decorators = [(0, swagger_1.ApiProperty)({ example: 'https://example.com/brochure.pdf' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return String(value !== null && value !== void 0 ? value : '').trim();
                }), (0, class_validator_1.MaxLength)(event_brochures_util_1.EVENT_BROCHURE_LINK_MAX)];
...
exports.EventBrochureItemDto = EventBrochureItemDto;
