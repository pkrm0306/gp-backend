...
var UpdateEventDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _eventStartDate_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    example: '2026-04-08',
            ...
            _eventEndDate_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    example: '2026-04-10',
            ...
            _brochures_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Replace all brochure cards. Each item requires heading and link. ' +
