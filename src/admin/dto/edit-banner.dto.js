    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _title_decorators = [(0, swagger_1.ApiPropertyOptional)({
                ...
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, readable_text_validator_1.IsReadableNotEmpty)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
            ...
            _imageSource_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'How the image was supplied (informational). On edit, the server sets **binary_upload** when a new `image` file is sent, or **manual_url** when `imageUrl` is provided.',
            ...
            _description_decorators = [(0, swagger_1.ApiPropertyOptional)({
                ...
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, readable_text_validator_1.IsReadableNotEmpty)(), (0, readable_text_validator_1.MaxReadableLength)(1000), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return value === undefined || value === null ? undefined : String(value).trim();
                })];
...
exports.EditBannerDto = EditBannerDto;
