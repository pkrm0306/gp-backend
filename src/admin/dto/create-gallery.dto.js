...
var CreateGalleryDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _eventDate_decorators = [(0, swagger_1.ApiProperty)({
                    example: '2026-04-08',
            ...
            _galleryType_decorators = [(0, swagger_1.ApiProperty)({
                    example: 'Training & Workshops',
                    enum: gallery_schema_1.GALLERY_TYPES,
                    description: 'Gallery tab/type for add form dropdown. Only Training & Workshops, Site Visits, Recognition.',
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return String(value !== null && value !== void 0 ? value : '').trim();
