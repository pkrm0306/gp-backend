...
exports.ProcessRenewInnovationService = void 0;
...
var ProcessRenewInnovationService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var ProcessRenewInnovationService = _classThis = /** @class */ (function () {
        function ProcessRenewInnovationService_1(renewInnovationModel, renewDocumentModel, renewalCycleModel, productModel, connection, sequenceHelper, documentVersioningService) {
        ...
        ProcessRenewInnovationService_1.prototype.upsert = function (input, files) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, cycle, context, urnStatus, ownership, renewalCycleObjectId, headerFilter, session, now, trimmedUrn, existing, processRenewInnovationId, _b, innovationImplementationDocuments, uploadedFiles, filePaths, _i, uploadedFiles_1, file, uploaded, oldFileLinksToDeleteAfterCommit, saved, newDocRows, i, _c, _d, _e, oldFileLinksToDeleteAfterCommit_1, link, error_1;
                var _f;
                var _g, _h, _j, _k, _l;
                return __generator(this, function (_m) {
                    switch (_m.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, this.renewInnovationModel
                                    .findOne(headerFilter)
                                    .session(session)];
                        case 4:
                            existing = _m.sent();
                            if (!((_g = existing === null || existing === void 0 ? void 0 : existing.processRenewInnovationId) !== null && _g !== void 0)) return [3 /*break*/, 5];
                            _b = _g;
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, this.sequenceHelper.getProcessRenewInnovationId()];
                        case 6:
                            _b = (_m.sent());
                            _m.label = 7;
                        case 7:
                            processRenewInnovationId = _b;
                            innovationImplementationDocuments = (_h = existing === null || existing === void 0 ? void 0 : existing.innovationImplementationDocuments) !== null && _h !== void 0 ? _h : 0;
                        ...
                        case 12:
                            ...
                            return [4 /*yield*/, this.renewInnovationModel
                                    ...
                                    $set: {
                                        ...
                                        innovationImplementationDetails: (_k = input.innovationImplementationDetails) !== null && _k !== void 0 ? _k : '',
                                        innovationImplementationDocuments: innovationImplementationDocuments,
                                        processInnovationStatus: (_l = input.processInnovationStatus) !== null && _l !== void 0 ? _l : 0,
                                        updatedDate: now,
                                    },
                                    $setOnInsert: {
                                        processRenewInnovationId: processRenewInnovationId,
                                        urnNo: trimmedUrn,
                                        createdDate: now,
                                    },
                        ...
                        case 15:
                            _d.apply(_c, [(_f.productDocumentId = _m.sent(),
                                    _f.documentFormSubsection = 'innovation_implementation_documents',
                        ...
                        case 25:
                            _m.sent();
                            session.endSession();
                            throw new common_1.InternalServerErrorException(error_1.message || 'Failed to save renew innovation');
                        case 26: return [2 /*return*/];
                    }
                });
            });
        };
        ProcessRenewInnovationService_1.prototype.getByUrn = function (urnNo, renewalCycleId) {
            return __awaiter(this, void 0, void 0, function () {
                    ...
                    switch (_b.label) {
                        ...
                        case 5:
                            ...
                            docFilter = (cycle === null || cycle === void 0 ? void 0 : cycle._id) != null
                                ? (0, renew_section_documents_util_1.buildRenewSectionDocMigrationFilter)(trimmedUrn, cycle._id, document_section_key_constants_1.DocumentSectionKey.PROCESS_INNOVATION, Number((_a = cycle.cycleNo) !== null && _a !== void 0 ? _a : 1) > 1)
                                : {
                                    urnNo: trimmedUrn,
        ...
        return ProcessRenewInnovationService_1;
    }());
    __setFunctionName(_classThis, "ProcessRenewInnovationService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ProcessRenewInnovationService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessRenewInnovationService = _classThis;
}();
exports.ProcessRenewInnovationService = ProcessRenewInnovationService;
