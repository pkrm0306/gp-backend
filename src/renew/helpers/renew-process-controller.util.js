...
exports.assertRenewProcessActorForUrn = assertRenewProcessActorForUrn;
exports.assertRenewProcessActorCanReadUrn = assertRenewProcessActorCanReadUrn;
...
function assertRenewProcessActorForUrn(productModel, user, urnNo) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            return [2 /*return*/, (0, renew_common_util_1.assertRenewActorCanEditUrn)(productModel, urnNo, actorId)];
        });
    });
}
/** Vendor JWT ownership check for read-only renew GETs (certified browse, locked review). */
function assertRenewProcessActorCanReadUrn(productModel, user, urnNo) {
    return __awaiter(this, void 0, void 0, function () {
        var actorId;
        var _a, _b;
        return __generator(this, function (_c) {
            ...
            actorId = (_b = (_a = user === null || user === void 0 ? void 0 : user.vendorId) !== null && _a !== void 0 ? _a : user === null || user === void 0 ? void 0 : user.manufacturerId) !== null && _b !== void 0 ? _b : null;
            return [2 /*return*/, (0, renew_common_util_1.assertRenewActorCanReadUrn)(productModel, urnNo, actorId)];
        });
    });
}
