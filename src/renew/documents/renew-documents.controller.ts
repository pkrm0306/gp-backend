...
export class RenewDocumentsController {
  ...
  @ApiOperation({ summary: 'Soft-delete a renewal product document' })
  ...
  async deleteDocument(
    ...
    if (!urnNo?.trim() || !sectionKey?.trim()) {

      throw new BadRequestException('urnNo and sectionKey are required');
