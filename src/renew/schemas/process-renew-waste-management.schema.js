...
exports.ProcessRenewWasteManagementSchema = exports.ProcessRenewWasteManagement = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var ProcessRenewWasteManagement = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'process_renew_waste_management', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _processRenewWasteManagementId_decorators;
    var _processRenewWasteManagementId_initializers = [];
    var _processRenewWasteManagementId_extraInitializers = [];
    ...
    var ProcessRenewWasteManagement = _classThis = /** @class */ (function () {
        function ProcessRenewWasteManagement_1() {
            this.processRenewWasteManagementId = __runInitializers(this, _processRenewWasteManagementId_initializers, void 0);
            this.vendorId = (__runInitializers(this, _processRenewWasteManagementId_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            ...
            this.wmImplementationDetails = (__runInitializers(this, _renewalCycleId_extraInitializers), __runInitializers(this, _wmImplementationDetails_initializers, void 0));
            this.wmSupportingDocuments = (__runInitializers(this, _wmImplementationDetails_extraInitializers), __runInitializers(this, _wmSupportingDocuments_initializers, void 0));
            this.processWasteManagementStatus = (__runInitializers(this, _wmSupportingDocuments_extraInitializers), __runInitializers(this, _processWasteManagementStatus_initializers, void 0));
        ...
        return ProcessRenewWasteManagement_1;
    }());
    __setFunctionName(_classThis, "ProcessRenewWasteManagement");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _processRenewWasteManagementId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _wmSupportingDocuments_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number, default: 0 })];
        ...
        __esDecorate(null, null, _processRenewWasteManagementId_decorators, { kind: "field", name: "processRenewWasteManagementId", static: false, private: false, access: { has: function (obj) { return "processRenewWasteManagementId" in obj; }, get: function (obj) { return obj.processRenewWasteManagementId; }, set: function (obj, value) { obj.processRenewWasteManagementId = value; } }, metadata: _metadata }, _processRenewWasteManagementId_initializers, _processRenewWasteManagementId_extraInitializers);
        ...
        ProcessRenewWasteManagement = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessRenewWasteManagement = _classThis;
}();
exports.ProcessRenewWasteManagement = ProcessRenewWasteManagement;
exports.ProcessRenewWasteManagementSchema = mongoose_1.SchemaFactory.createForClass(ProcessRenewWasteManagement);
exports.ProcessRenewWasteManagementSchema.index({ urnNo: 1, renewalCycleId: 1 }, { unique: true, name: 'uniq_process_renew_waste_management_urn_cycle' });
