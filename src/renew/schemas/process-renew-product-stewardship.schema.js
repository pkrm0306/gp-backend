...
exports.ProcessRenewProductStewardshipSchema = exports.ProcessRenewProductStewardship = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var ProcessRenewProductStewardship = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'process_renew_product_stewardship', timestamps: false })];
    ...
    var ProcessRenewProductStewardship = _classThis = /** @class */ (function () {
        function ProcessRenewProductStewardship_1() {
            this.processRenewProductStewardshipId = __runInitializers(this, _processRenewProductStewardshipId_initializers, void 0);
            this.vendorId = (__runInitializers(this, _processRenewProductStewardshipId_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            ...
            this.seaSupportingDocuments = (__runInitializers(this, _renewalCycleId_extraInitializers), __runInitializers(this, _seaSupportingDocuments_initializers, void 0));
            ...
            this.qmSupportingDocuments = (__runInitializers(this, _qualityManagementDetails_extraInitializers), __runInitializers(this, _qmSupportingDocuments_initializers, void 0));
            ...
            this.eprSupportingDocuments = (__runInitializers(this, _eprGreenPackagingDetails_extraInitializers), __runInitializers(this, _eprSupportingDocuments_initializers, void 0));
            this.productStewardshipStatus = (__runInitializers(this, _eprSupportingDocuments_extraInitializers), __runInitializers(this, _productStewardshipStatus_initializers, void 0));
        ...
        return ProcessRenewProductStewardship_1;
    }());
    __setFunctionName(_classThis, "ProcessRenewProductStewardship");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _processRenewProductStewardshipId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _seaSupportingDocuments_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number, default: 0 })];
        _qualityManagementDetails_decorators = [(0, mongoose_1.Prop)({ required: false })];
        _qmSupportingDocuments_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number, default: 0 })];
        ...
        _eprSupportingDocuments_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number, default: 0 })];
        ...
        ProcessRenewProductStewardship = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessRenewProductStewardship = _classThis;
}();
exports.ProcessRenewProductStewardship = ProcessRenewProductStewardship;
exports.ProcessRenewProductStewardshipSchema = mongoose_1.SchemaFactory.createForClass(ProcessRenewProductStewardship);
exports.ProcessRenewProductStewardshipSchema.index({ urnNo: 1, renewalCycleId: 1 }, { unique: true, name: 'uniq_process_renew_product_stewardship_urn_cycle' });
