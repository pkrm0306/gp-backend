...
exports.UrnRenewTabReviewSchema = exports.UrnRenewTabReview = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var UrnRenewTabReview = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'urn_renew_tab_reviews', timestamps: true })];
    ...
    var UrnRenewTabReview = _classThis = /** @class */ (function () {
        function UrnRenewTabReview_1() {
            ...
            this.tabKey = (__runInitializers(this, _renewalCycleId_extraInitializers), __runInitializers(this, _tabKey_initializers, void 0));
        ...
        return UrnRenewTabReview_1;
    }());
    __setFunctionName(_classThis, "UrnRenewTabReview");
    (function () {
        ...
        UrnRenewTabReview = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UrnRenewTabReview = _classThis;
}();
exports.UrnRenewTabReview = UrnRenewTabReview;
exports.UrnRenewTabReviewSchema = mongoose_1.SchemaFactory.createForClass(UrnRenewTabReview);
exports.UrnRenewTabReviewSchema.index({ urnNo: 1, renewalCycleId: 1, tabKey: 1, stepId: 1 }, { unique: true });
exports.UrnRenewTabReviewSchema.index({
    urnNo: 1,
    renewalCycleId: 1,
    reviewStatus: 1,
});
