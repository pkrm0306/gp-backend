...
exports.ProcessRenewProductPerformanceSchema = exports.ProcessRenewProductPerformance = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var ProcessRenewProductPerformance = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'process_renew_product_performance', timestamps: false })];
    ...
    var ProcessRenewProductPerformance = _classThis = /** @class */ (function () {
        function ProcessRenewProductPerformance_1() {
            this.processRenewProductPerformanceId = __runInitializers(this, _processRenewProductPerformanceId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _processRenewProductPerformanceId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
            ...
            this.testReports = (__runInitializers(this, _testReportFileName_extraInitializers), __runInitializers(this, _testReports_initializers, void 0));
            this.testReportFiles = (__runInitializers(this, _testReports_extraInitializers), __runInitializers(this, _testReportFiles_initializers, void 0));
            this.renewalType = (__runInitializers(this, _testReportFiles_extraInitializers), __runInitializers(this, _renewalType_initializers, void 0));
        ...
        return ProcessRenewProductPerformance_1;
    }());
    __setFunctionName(_classThis, "ProcessRenewProductPerformance");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _processRenewProductPerformanceId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _productName_decorators = [(0, mongoose_1.Prop)()];
        _testReportFileName_decorators = [(0, mongoose_1.Prop)()];
        ...
        _testReportFiles_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number, default: 0 })];
        _renewalType_decorators = [(0, mongoose_1.Prop)({ required: true, type: Number, default: 0 })];
        ...
        ProcessRenewProductPerformance = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProcessRenewProductPerformance = _classThis;
}();
exports.ProcessRenewProductPerformance = ProcessRenewProductPerformance;
exports.ProcessRenewProductPerformanceSchema = mongoose_1.SchemaFactory.createForClass(ProcessRenewProductPerformance);
exports.ProcessRenewProductPerformanceSchema.index({ urnNo: 1, renewalCycleId: 1 }, { unique: true, name: 'uniq_process_renew_pp_urn_cycle' });
