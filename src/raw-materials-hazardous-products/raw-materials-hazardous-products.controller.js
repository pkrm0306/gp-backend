...
exports.RawMaterialsHazardousProductsController = void 0;
...
var HAZARDOUS_PRODUCT_FILE_FIELDS = [
...
var RawMaterialsHazardousProductsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Raw Materials Hazardous Products'), (0, common_1.Controller)('raw-materials-hazardous-products'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var RawMaterialsHazardousProductsController = _classThis = /** @class */ (function () {
        function RawMaterialsHazardousProductsController_1(service, stepGate) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.stepGate = stepGate;
        }
        RawMaterialsHazardousProductsController_1.prototype.replace = function (user, req) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            uploadedFiles = (0, raw_materials_upload_util_2.collectAllUploadFiles)(req.files).filter(function (f) { var _a; return HAZARDOUS_PRODUCT_FILE_FIELDS.includes(String((_a = f.fieldname) !== null && _a !== void 0 ? _a : '')); });
                            if (uploadedFiles.length > 0) {
                                (0, raw_materials_upload_util_2.assertRawMaterialsDocumentTypes)(uploadedFiles);
                            }
                            meaningfulIncoming = productsJson.filter(function (row) {
                                return (0, form_partial_field_util_1.hasPartialRawMaterialsProductRow)((0, form_partial_field_util_1.normalizeRawMaterialsProductRow)(row));
                            });
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.service.replaceByUrn({
                                    urnNo: urnNo,
                                    vendorId: user.vendorId,
                                    eoiNo: (0, raw_materials_upload_util_2.parseRawMaterialsFormString)(body.eoiNo),
                                    products: productsJson,
                                    uploadedFiles: uploadedFiles,
                                    existingDocumentIds: (0, product_design_upload_util_1.parseMultipartJsonIdArray)(body.existingDocumentIds),
                                    actor: {
                                        user_id: (user === null || user === void 0 ? void 0 : user.userId) ? String(user.userId) : undefined,
                                        name: (user === null || user === void 0 ? void 0 : user.name) ? String(user.name) : undefined,
                                        email: (user === null || user === void 0 ? void 0 : user.email) ? String(user.email) : undefined,
                                        role: (user === null || user === void 0 ? void 0 : user.role) ? String(user.role) : undefined,
                                        vendor_id: (user === null || user === void 0 ? void 0 : user.vendorId) ? String(user.vendorId) : undefined,
                                        manufacturer_id: (user === null || user === void 0 ? void 0 : user.manufacturerId)
        ...
        RawMaterialsHazardousProductsController_1.prototype.create = function (user, req) {
            return __awaiter(this, void 0, void 0, function () {
                var body, urnNo, uploadedFiles, uploadFiles, primaryFile, productRow, hasProductText, replaceTableBeforeInsert, meaningfulProductCount, data_1, dto, data;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            uploadFiles = uploadedFiles.filter(function (f) { var _a; return HAZARDOUS_PRODUCT_FILE_FIELDS.includes(String((_a = f.fieldname) !== null && _a !== void 0 ? _a : '')); });
                            primaryFile = (_b = (0, raw_materials_upload_util_2.pickUploadFile)(uploadFiles, HAZARDOUS_PRODUCT_FILE_FIELDS)) !== null && _b !== void 0 ? _b : uploadFiles[0];
                        ...
                        case 2:
                            _c.sent();
                            if (!(!hasProductText && uploadFiles.length > 0)) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.service.createDocumentsOnly(urnNo, user.vendorId, uploadFiles, (0, raw_materials_upload_util_2.parseRawMaterialsFormString)(body.eoiNo))];
                        case 3:
                            data_1 = _c.sent();
                            return [2 /*return*/, {
                                    success: true,
                        ...
                        case 4:
                            dto = {
                                ...
                                productsTestReportFileName: (0, raw_materials_upload_util_2.parseRawMaterialsFormString)(body.productsTestReportFileName),
                            };
                            return [4 /*yield*/, this.service.create(dto, user.vendorId, primaryFile, {
        ...
        RawMaterialsHazardousProductsController_1.prototype.listByUrn = function (user, urnNo) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
        ...
        return RawMaterialsHazardousProductsController_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsHazardousProductsController");
    (function () {
        ...
        _replace_decorators = [(0, common_1.Post)('replace'), (0, swagger_1.ApiOperation)({
                ...
                description: '**Full replace** of `raw_materials_hazardous_products` for the URN. Send the complete `products` JSON array from the vendor table. Empty `[]` clears all product rows. New files go to documents only when `products` is empty. `existingDocumentIds`: omit = keep all docs; `[]` = remove unlisted.',
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({
                ...
                description: 'Inserts **one** row unless `replaceTable=true` or `rowIndex=0` (deletes all rows for URN first). ' +
        ...
        RawMaterialsHazardousProductsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsHazardousProductsController = _classThis;
}();
exports.RawMaterialsHazardousProductsController = RawMaterialsHazardousProductsController;
