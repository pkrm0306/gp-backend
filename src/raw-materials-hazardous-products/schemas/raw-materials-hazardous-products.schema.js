...
exports.RawMaterialsHazardousProductsSchema = exports.RawMaterialsHazardousProducts = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var RawMaterialsHazardousProducts = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'raw_materials_hazardous_products', timestamps: false })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _rawMaterialsHazardousProductsId_decorators;
    var _rawMaterialsHazardousProductsId_initializers = [];
    var _rawMaterialsHazardousProductsId_extraInitializers = [];
    ...
    var RawMaterialsHazardousProducts = _classThis = /** @class */ (function () {
        function RawMaterialsHazardousProducts_1() {
            this.rawMaterialsHazardousProductsId = __runInitializers(this, _rawMaterialsHazardousProductsId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _rawMaterialsHazardousProductsId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
        ...
        return RawMaterialsHazardousProducts_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsHazardousProducts");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _rawMaterialsHazardousProductsId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _productsName_decorators = [(0, mongoose_1.Prop)({ required: false })];
        _productsTestReport_decorators = [(0, mongoose_1.Prop)({ required: false })];
        _createdDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _updatedDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        __esDecorate(null, null, _rawMaterialsHazardousProductsId_decorators, { kind: "field", name: "rawMaterialsHazardousProductsId", static: false, private: false, access: { has: function (obj) { return "rawMaterialsHazardousProductsId" in obj; }, get: function (obj) { return obj.rawMaterialsHazardousProductsId; }, set: function (obj, value) { obj.rawMaterialsHazardousProductsId = value; } }, metadata: _metadata }, _rawMaterialsHazardousProductsId_initializers, _rawMaterialsHazardousProductsId_extraInitializers);
        ...
        RawMaterialsHazardousProducts = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsHazardousProducts = _classThis;
}();
exports.RawMaterialsHazardousProducts = RawMaterialsHazardousProducts;
exports.RawMaterialsHazardousProductsSchema = mongoose_1.SchemaFactory.createForClass(RawMaterialsHazardousProducts);
