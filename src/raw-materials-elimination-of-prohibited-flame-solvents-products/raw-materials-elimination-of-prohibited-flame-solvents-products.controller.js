...
exports.RawMaterialsEliminationOfProhibitedFlameSolventsProductsController = void 0;
...
var SOLVENTS_PRODUCT_FILE_FIELDS = [
...
function collectSolventsProductUploadFiles(uploadedFiles) {
    var all = (0, raw_materials_upload_util_2.collectAllUploadFiles)(uploadedFiles);
    var matched = all.filter(function (f) { var _a; return SOLVENTS_PRODUCT_FILE_FIELDS.includes(String((_a = f.fieldname) !== null && _a !== void 0 ? _a : '')); });
    return matched.length > 0 ? matched : all;
}
var RawMaterialsEliminationOfProhibitedFlameSolventsProductsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Raw Materials Elimination Of Prohibited Flame Solvents Products'), (0, common_1.Controller)('raw-materials-elimination-of-prohibited-flame-solvents-products'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var RawMaterialsEliminationOfProhibitedFlameSolventsProductsController = _classThis = /** @class */ (function () {
        function RawMaterialsEliminationOfProhibitedFlameSolventsProductsController_1(service, stepGate) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.stepGate = stepGate;
        }
        RawMaterialsEliminationOfProhibitedFlameSolventsProductsController_1.prototype.replace = function (user, req) {
            return __awaiter(this, void 0, void 0, function () {
                var body, urnNo, productsJson, meaningfulIncoming, uploadFiles, persistedProductCount, data;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            productsJson = (0, raw_materials_upload_util_2.resolveRawMaterialsProductsPayload)(body);
                            ...
                            uploadFiles = collectSolventsProductUploadFiles(req.files);
                            ...
                            return [4 /*yield*/, this.stepGate.assertStepSubmitAllowed({
                                    ...
                                    rows: meaningfulIncoming.length > 0
                                        ...
                                        : (0, form_partial_field_util_1.hasPartialRawMaterialsProductRow)((0, form_partial_field_util_1.normalizeRawMaterialsProductRow)(body))
                                            ? [(0, form_partial_field_util_1.normalizeRawMaterialsProductRow)(body)]
                                            : productsJson,
                                    body: body,
                                    multipartBody: body,
                        ...
                        case 3:
                            ...
                            return [2 /*return*/, {
                                    success: true,
                                    message: 'Raw materials prohibited flame solvents products saved successfully',
                                    data: data,
                                }];
                    }
                });
        ...
        RawMaterialsEliminationOfProhibitedFlameSolventsProductsController_1.prototype.create = function (user, req) {
            return __awaiter(this, void 0, void 0, function () {
                var body, urnNo, uploadFiles, productRow, hasProductText, replaceTableBeforeInsert, meaningfulProductCount, data_1, dto, data;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.service.countMeaningfulProductsByUrn(urnNo, user.vendorId)];
                        case 1:
                            meaningfulProductCount = _b.sent();
                            return [4 /*yield*/, this.stepGate.assertStepSubmitAllowed({
                                    vendorId: user.vendorId,
                                    urnNo: urnNo,
                                    documentForm: SOLVENTS_PRODUCTS_DOCUMENT_FORMS,
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.service.create({ urnNo: urnNo }, user.vendorId, { uploadFiles: uploadFiles })];
                        case 3:
                            data_1 = _b.sent();
                            return [2 /*return*/, {
                                    success: true,
        ...
        RawMaterialsEliminationOfProhibitedFlameSolventsProductsController_1.prototype.listByUrn = function (user, urnNo) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
        ...
        return RawMaterialsEliminationOfProhibitedFlameSolventsProductsController_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsEliminationOfProhibitedFlameSolventsProductsController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _replace_decorators = [(0, common_1.Post)('replace'), (0, swagger_1.ApiOperation)({
                summary: 'Replace all prohibited flame solvents product rows for a URN (full snapshot)',
                description: '**Full replace** of product rows. Send complete `products` JSON array. Multiple supporting files allowed. `existingDocumentIds`: omit = keep all docs; `[]` = remove unlisted.',
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({
                ...
                description: 'Inserts one row unless `replaceTable=true` or `rowIndex=0`. Supports optional supporting PDF/Excel uploads with text-only or file-only partial saves.',
            }), (0, common_1.UseInterceptors)((0, platform_express_1.AnyFilesInterceptor)((0, raw_materials_upload_util_1.rawMaterialsMultipartMemoryMulterOptions)())), (0, swagger_1.ApiConsumes)('multipart/form-data', 'application/json'), (0, swagger_1.ApiBody)({
                schema: {
                    type: 'object',
                    required: ['urnNo'],
        ...
        RawMaterialsEliminationOfProhibitedFlameSolventsProductsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsEliminationOfProhibitedFlameSolventsProductsController = _classThis;
}();
exports.RawMaterialsEliminationOfProhibitedFlameSolventsProductsController = RawMaterialsEliminationOfProhibitedFlameSolventsProductsController;
