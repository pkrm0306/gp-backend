...
exports.RawMaterialsEliminationOfProhibitedFlameSolventsProductsSchema = exports.RawMaterialsEliminationOfProhibitedFlameSolventsProducts = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var raw_materials_schema_props_1 = require("../../common/raw-materials/raw-materials-schema.props");
var RawMaterialsEliminationOfProhibitedFlameSolventsProducts = function () {
    ...
    var _classThis;
    var _rawMaterialsEliminationProhibitedFlameSolventsProductsId_decorators;
    var _rawMaterialsEliminationProhibitedFlameSolventsProductsId_initializers = [];
    var _rawMaterialsEliminationProhibitedFlameSolventsProductsId_extraInitializers = [];
    ...
    var RawMaterialsEliminationOfProhibitedFlameSolventsProducts = _classThis = /** @class */ (function () {
        function RawMaterialsEliminationOfProhibitedFlameSolventsProducts_1() {
            this.rawMaterialsEliminationProhibitedFlameSolventsProductsId = __runInitializers(this, _rawMaterialsEliminationProhibitedFlameSolventsProductsId_initializers, void 0);
            this.urnNo = (__runInitializers(this, _rawMaterialsEliminationProhibitedFlameSolventsProductsId_extraInitializers), __runInitializers(this, _urnNo_initializers, void 0));
            this.vendorId = (__runInitializers(this, _urnNo_extraInitializers), __runInitializers(this, _vendorId_initializers, void 0));
            // @Prop({ required: true })
            this.productsName = (__runInitializers(this, _vendorId_extraInitializers), __runInitializers(this, _productsName_initializers, void 0));
            // @Prop({ required: true })
            ...
            this.createdDate = (__runInitializers(this, _productsTestReport_extraInitializers), __runInitializers(this, _createdDate_initializers, void 0));
        ...
        return RawMaterialsEliminationOfProhibitedFlameSolventsProducts_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsEliminationOfProhibitedFlameSolventsProducts");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _rawMaterialsEliminationProhibitedFlameSolventsProductsId_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        _productsName_decorators = [(0, mongoose_1.Prop)(raw_materials_schema_props_1.RM_PARTIAL_TEXT)];
        _productsTestReport_decorators = [(0, mongoose_1.Prop)(raw_materials_schema_props_1.RM_PARTIAL_TEXT)];
        _createdDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _updatedDate_decorators = [(0, mongoose_1.Prop)({ required: true })];
        __esDecorate(null, null, _rawMaterialsEliminationProhibitedFlameSolventsProductsId_decorators, { kind: "field", name: "rawMaterialsEliminationProhibitedFlameSolventsProductsId", static: false, private: false, access: { has: function (obj) { return "rawMaterialsEliminationProhibitedFlameSolventsProductsId" in obj; }, get: function (obj) { return obj.rawMaterialsEliminationProhibitedFlameSolventsProductsId; }, set: function (obj, value) { obj.rawMaterialsEliminationProhibitedFlameSolventsProductsId = value; } }, metadata: _metadata }, _rawMaterialsEliminationProhibitedFlameSolventsProductsId_initializers, _rawMaterialsEliminationProhibitedFlameSolventsProductsId_extraInitializers);
        ...
        RawMaterialsEliminationOfProhibitedFlameSolventsProducts = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsEliminationOfProhibitedFlameSolventsProducts = _classThis;
}();
exports.RawMaterialsEliminationOfProhibitedFlameSolventsProducts = RawMaterialsEliminationOfProhibitedFlameSolventsProducts;
exports.RawMaterialsEliminationOfProhibitedFlameSolventsProductsSchema = mongoose_1.SchemaFactory.createForClass(RawMaterialsEliminationOfProhibitedFlameSolventsProducts);
