...
var EMAIL = process.env.PLATFORM_ADMIN_EMAIL || 'admin@greenpro.com';
var PASSWORD = process.env.PLATFORM_ADMIN_PASSWORD || 'Greenpro@123';
var NAME = process.env.PLATFORM_ADMIN_NAME || 'Platform Admin';
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    console.log("Updated platform admin: ".concat(EMAIL));
                    return [4 /*yield*/, app.close()];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
                case 5: return [4 /*yield*/, vendorUsers.create({
                        name: NAME,
                        email: EMAIL,
                ...
                case 6:
                    _a.sent();
                    console.log("Seeded platform admin (no manufacturer): ".concat(EMAIL));
                    return [4 /*yield*/, app.close()];
                case 7:
                    _a.sent();
                    return [2 /*return*/];
