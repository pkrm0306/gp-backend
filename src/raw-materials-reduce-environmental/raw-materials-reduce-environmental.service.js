...
exports.RawMaterialsReduceEnvironmentalService = void 0;
...
var RawMaterialsReduceEnvironmentalService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var RawMaterialsReduceEnvironmentalService = _classThis = /** @class */ (function () {
        function RawMaterialsReduceEnvironmentalService_1(model, allProductDocumentModel, productModel, sequenceHelper, documentVersioningService) {
            this.model = model;
        ...
        RawMaterialsReduceEnvironmentalService_1.prototype.toObjectId = function (id, fieldName) {
        ...
        RawMaterialsReduceEnvironmentalService_1.prototype.saveFileToUrnFolder = function (file, urnNo) {
        ...
        RawMaterialsReduceEnvironmentalService_1.prototype.syncDocuments = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var urnNo, vendorObjectId, formPrimaryId, uploadFiles, existingDocumentIds, now, existingDocs, keepRefs, oldLinks, docsToDelete, _i, existingDocs_1, doc, keep, documents, i, file, uploaded, productDocumentId, d, _a, oldLinks_1, link, _b;
                    ...
                    switch (_c.label) {
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, (0, product_document_version_integration_1.trackProductDocumentDeleteBatch)({
                                    ...
                                    urnNo: urnNo,
                                    sectionKey: document_section_key_constants_1.DocumentSectionKey.RAW_MATERIALS_REDUCE_ENVIROMENTAL,
                        ...
                        case 10:
                            ...
                            return [4 /*yield*/, this.allProductDocumentModel.create({
                                    ...
                                    urnNo: urnNo,
                                    eoiNo: '',
                                    documentForm: document_section_key_constants_1.DocumentSectionKey.RAW_MATERIALS_REDUCE_ENVIROMENTAL,
        ...
        RawMaterialsReduceEnvironmentalService_1.prototype.create = function (dto, vendorId, options) {
            return __awaiter(this, void 0, void 0, function () {
                var vendorObjectId, urnNo, now, replaceAllRows, meaningfulUnits, rowsToInsert, _i, meaningfulUnits_1, unit, generatedId, createdRows, _a, uploadFiles, documents, formPrimaryId, _b, error_1;
                var _c, _d, _e, _f;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            now = new Date();
                            replaceAllRows = (options === null || options === void 0 ? void 0 : options.replaceAllRows) !== false;
                            meaningfulUnits = (0, raw_materials_upload_util_2.filterMeaningfulRows)(((_c = dto.units) !== null && _c !== void 0 ? _c : []), QUARRYING_UNIT_KEYS);
                            rowsToInsert = [];
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.sequenceHelper.getRawMaterialsReduceEnvironmentalId()];
                        case 2:
                            generatedId = _g.sent();
                            rowsToInsert.push({
                                ...
                                greenBeltDevelopmentAndBioDiversity: unit.greenBeltDevelopmentAndBioDiversity.trim(),
                                createdDate: now,
                                updatedDate: now,
                            });
                            _g.label = 3;
                        case 3:
                            ...
                            return [3 /*break*/, 1];
                        case 4:
                            if (!replaceAllRows) return [3 /*break*/, 6];
                            return [4 /*yield*/, this.model.deleteMany({ urnNo: urnNo, vendorId: vendorObjectId })];
                        case 5:
                            _g.sent();
                            _g.label = 6;
                        case 6:
                            if (!(rowsToInsert.length > 0)) return [3 /*break*/, 8];
                            return [4 /*yield*/, this.model.insertMany(rowsToInsert)];
                        case 7:
                            _a = _g.sent();
                            return [3 /*break*/, 9];
                        case 8:
                        ...
                        case 9:
                            createdRows = _a;
                            uploadFiles = (_d = options === null || options === void 0 ? void 0 : options.uploadFiles) !== null && _d !== void 0 ? _d : [];
                            documents = void 0;
                            if (!(uploadFiles.length > 0 || (options === null || options === void 0 ? void 0 : options.existingDocumentIds) !== undefined)) return [3 /*break*/, 14];
                            if (!((_f = (_e = createdRows[0]) === null || _e === void 0 ? void 0 : _e.rawMaterialsReduceEnvironmentalId) !== null && _f !== void 0)) return [3 /*break*/, 10];
                            _b = _f;
                            return [3 /*break*/, 12];
                        case 10: return [4 /*yield*/, this.sequenceHelper.getProductDocumentId()];
                        case 11:
                            _b = (_g.sent());
                            _g.label = 12;
                        case 12:
                        ...
                        case 13:
                            documents = _g.sent();
                            _g.label = 14;
                        case 14: return [2 /*return*/, __assign({ urnNo: urnNo, vendorId: vendorObjectId.toString(), units: createdRows }, (documents ? { documents: documents } : {}))];
                        case 15:
                            error_1 = _g.sent();
                            console.error('[Raw Materials Reduce Environmental] Create error:', error_1);
        ...
        RawMaterialsReduceEnvironmentalService_1.prototype.countPersistedByUrn = function (urnNo, vendorId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        RawMaterialsReduceEnvironmentalService_1.prototype.listByUrn = function (urnNo, vendorId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_2 = _a.sent();
                            console.error('[Raw Materials Reduce Environmental] List error:', error_2);
        ...
        return RawMaterialsReduceEnvironmentalService_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsReduceEnvironmentalService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RawMaterialsReduceEnvironmentalService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsReduceEnvironmentalService = _classThis;
}();
exports.RawMaterialsReduceEnvironmentalService = RawMaterialsReduceEnvironmentalService;
