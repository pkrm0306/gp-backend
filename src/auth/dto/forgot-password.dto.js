...
var ForgotPasswordDto = function () {
    ...
    return _a = /** @class */ (function () {
            function ForgotPasswordDto() {
                ...
                this.portal = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _portal_initializers, void 0));
        ...
        (function () {
            ...
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'user@example.com' }), (0, class_transformer_1.Transform)(function (_b) {
                    var _c;
                    var value = _b.value;
            ...
            _portal_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    enum: ['admin', 'vendor'],
                    description: 'When **admin**, unknown emails return **400** **Email id is not registered**. For **vendor** (or inferred non-admin), unknown emails return **400** **User not registered**.',
