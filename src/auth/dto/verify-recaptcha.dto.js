...
exports.VerifyRecaptchaDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var VerifyRecaptchaDto = function () {
    var _a;
    var _captchaToken_decorators;
    var _captchaToken_initializers = [];
    var _captchaToken_extraInitializers = [];
    return _a = /** @class */ (function () {
            function VerifyRecaptchaDto() {
                this.captchaToken = __runInitializers(this, _captchaToken_initializers, void 0);
                __runInitializers(this, _captchaToken_extraInitializers);
            }
            return VerifyRecaptchaDto;
        }()),
        (function () {
...
exports.VerifyRecaptchaDto = VerifyRecaptchaDto;
