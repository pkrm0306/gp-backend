...
function tokenFromAccessTokenHeader(req) {
    var _a;
    var h = req.headers['x-access-token'];
    if (typeof h === 'string' && h.trim()) {
        return h.trim();
    }
    if (Array.isArray(h) && ((_a = h[0]) === null || _a === void 0 ? void 0 : _a.trim())) {
        return h[0].trim();
    }
    return null;
}
var JwtStrategy = function () {
    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(configService, authService, sessionInvalidation) {
            ...
            _this.sessionInvalidation = sessionInvalidation;
            return _this;
        }
        JwtStrategy_1.prototype.validate = function (_req, payload) {
            return __awaiter(this, void 0, void 0, function () {
                var role, manufacturerId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.isTokenRevoked(payload === null || payload === void 0 ? void 0 : payload.jti)];
                        case 1:
                            if (_a.sent()) {
                        ...
                        case 2:
                            ...
                            if (!(role &&
                                ...
                                manufacturerId)) return [3 /*break*/, 5];
                            return [4 /*yield*/, this.authService.assertVendorOrganizationActive(String(manufacturerId))];
                        case 3:
                            _a.sent();
                            return [4 /*yield*/, this.authService.assertVendorPortalUserAccountActive(payload.userId)];
                        case 4:
                            _a.sent();
                            _a.label = 5;
                        case 5:
                            ...
                            if (!(0, platform_rbac_scope_util_1.isPlatformPortalAccountType)(String(role)) && !manufacturerId) {
                                throw new common_1.UnauthorizedException('Invalid token payload');
                            }
                            return [2 /*return*/, {
                                    ...
                                    manufacturerId: manufacturerId !== null && manufacturerId !== void 0 ? manufacturerId : undefined,
                                    vendorId: manufacturerId !== null && manufacturerId !== void 0 ? manufacturerId : undefined,
                                    role: role,
                                    type: role,
                                    name: payload.name,
                                    email: payload.email,
                                    tokenJti: payload === null || payload === void 0 ? void 0 : payload.jti,
                                }];
                    }
                });
            });
