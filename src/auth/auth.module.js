...
var auth_session_invalidation_service_1 = require("./auth-session-invalidation.service");
...
var captcha_service_1 = require("../common/services/captcha.service");
...
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                (0, common_1.forwardRef)(function () { return manufacturers_module_1.ManufacturersModule; }),
            ...
            providers: [
                ...
                auth_session_invalidation_service_1.AuthSessionInvalidationService,
                jwt_strategy_1.JwtStrategy,
                captcha_service_1.CaptchaService,
            ],
            exports: [auth_service_1.AuthService, auth_session_invalidation_service_1.AuthSessionInvalidationService, jwt_strategy_1.JwtStrategy],
        })];
