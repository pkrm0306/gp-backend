...
exports.RawMaterialsOptimizationOfRawMixController = void 0;
...
var RawMaterialsOptimizationOfRawMixController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Raw Materials Optimization Of Raw Mix'), (0, common_1.Controller)('raw-materials-optimization-of-raw-mix'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var RawMaterialsOptimizationOfRawMixController = _classThis = /** @class */ (function () {
        function RawMaterialsOptimizationOfRawMixController_1(service, stepGate) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
            this.stepGate = stepGate;
        }
        RawMaterialsOptimizationOfRawMixController_1.prototype.create = function (user, body, optimizationOfRawMixFile) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (optimizationOfRawMixFile) {
                                (0, raw_materials_upload_util_2.assertRawMaterialsDocumentTypes)([optimizationOfRawMixFile]);
                            }
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.service.create(dto, user.vendorId, optimizationOfRawMixFile)];
                        case 3:
                            data = _a.sent();
        ...
        RawMaterialsOptimizationOfRawMixController_1.prototype.listByUrn = function (user, urnNo) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return RawMaterialsOptimizationOfRawMixController_1;
    }());
    __setFunctionName(_classThis, "RawMaterialsOptimizationOfRawMixController");
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({
            ...
            }), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('optimizationOfRawMixFile', (0, raw_materials_upload_util_1.rawMaterialsMultipartMemoryMulterOptions)())), (0, swagger_1.ApiConsumes)('multipart/form-data', 'application/json'), (0, swagger_1.ApiBody)({
                schema: {
                    type: 'object',
                    required: ['urnNo'],
                    properties: {
        ...
        RawMaterialsOptimizationOfRawMixController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RawMaterialsOptimizationOfRawMixController = _classThis;
}();
exports.RawMaterialsOptimizationOfRawMixController = RawMaterialsOptimizationOfRawMixController;
